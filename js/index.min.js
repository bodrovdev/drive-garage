...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @fancyapps/ui */ \"./node_modules/@fancyapps/ui/dist/index.esm.js\");\n\n_fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind(\"[data-fancybox]\", {});\n\n//# sourceURL=webpack://gulp-starter/./src/js/libs/fancybox.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   accordionFunc: () => (/* binding */ accordionFunc)\n/* harmony export */ });\nfunction accordionFunc(rootClassName) {\n  window.addEventListener('load', () => {\n    let accordionList = document.querySelectorAll(\".\".concat(rootClassName, \"__accordion-item\"));\n    if (accordionList === null) {\n      return;\n    } else {\n      accordionList.forEach(item => {\n        let accordionItemContent = item.querySelector(\".\".concat(rootClassName, \"__accordion-item-content\"));\n        let accordionItemTop = item.querySelector(\".\".concat(rootClassName, \"__accordion-item-top\"));\n        item.addEventListener('click', () => {\n          if (item.classList.contains(\"\".concat(rootClassName, \"__accordion-item--active\"))) {\n            item.classList.remove(\"\".concat(rootClassName, \"__accordion-item--active\"));\n            item.setAttribute('style', '');\n          } else {\n            item.classList.add(\"\".concat(rootClassName, \"__accordion-item--active\"));\n            item.setAttribute(\"style\", \"height:\".concat(accordionItemContent.offsetHeight + accordionItemTop.offsetHeight, \"px; transition:all 0.3s;\"));\n          }\n        });\n      });\n    }\n  });\n}\n\n\n//# sourceURL=webpack://gulp-starter/./src/js/templates/accordionFunc.js?");

/***/ }),

/***/ "./src/js/templates/modalFunc.js":
/*!***************************************!*\
  !*** ./src/js/templates/modalFunc.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   modalFunc: () => (/* binding */ modalFunc)\n/* harmony export */ });\n/* harmony import */ var tua_body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tua-body-scroll-lock */ \"./node_modules/tua-body-scroll-lock/dist/tua-bsl.esm.js\");\n\n\n// ? --- Модалки\nfunction modalFunc(rootClassName) {\n  window.addEventListener('load', () => {\n    if (document.querySelector(\".\".concat(rootClassName)) !== null && document.querySelector(\".\".concat(rootClassName, \"__form\")) !== null) {\n      let modal = document.querySelector(\".\".concat(rootClassName));\n      let modal_wrapper = document.querySelector(\".\".concat(rootClassName, \"__wrapper\"));\n      let modal_inner = modal.querySelector(\".\".concat(rootClassName, \"__inner\"));\n      let modal_success = modal.querySelector(\".\".concat(rootClassName, \"__success\"));\n      let modal_buttons = document.querySelectorAll(\".\".concat(rootClassName, \"__button\"));\n      let modal_close = modal.querySelector(\".\".concat(rootClassName, \"__close\"));\n      let modal_form = document.querySelectorAll(\".\".concat(rootClassName, \"__form\"));\n      function modalClose() {\n        if (modal.contains(modal_inner)) {\n          // * Если обычная модалка\n          modal.classList.remove(\"\".concat(rootClassName, \"--active\"));\n          modal_inner.classList.remove(\"\".concat(rootClassName, \"__inner--hidden\"));\n          modal_success.classList.remove(\"\".concat(rootClassName, \"__success--active\"));\n          (0,tua_body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__.unlock)(modal);\n        } else {\n          // * Если модалка с подтверждением отправки\n          modal.classList.remove(\"\".concat(rootClassName, \"--active\"));\n          (0,tua_body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__.unlock)(modal);\n        }\n      }\n      function modalClickOutside(e) {\n        if (!Array.from(modal_buttons).includes(e.target) && !modal_wrapper.contains(e.target)) {\n          modalClose();\n        }\n      }\n\n      // ? - Открытие\n      modal_buttons.forEach(button => {\n        button.addEventListener('click', () => {\n          modal.classList.add(\"\".concat(rootClassName, \"--active\"));\n          (0,tua_body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__.lock)(modal);\n          window.addEventListener('click', e => {\n            modalClickOutside(e);\n          });\n        });\n      });\n\n      // ? - Закрытие по клику на кнопку\n      modal_close.addEventListener('click', () => {\n        modalClose();\n        window.removeEventListener('click', e => {\n          modalClickOutside(e);\n        });\n      });\n\n      // ? - Закрытие по нажатию на esc\n      window.addEventListener('keydown', e => {\n        if (e.key === \"Escape\") {\n          modalClose();\n          window.removeEventListener('click', e => {\n            modalClickOutside(e);\n          });\n        }\n      });\n\n      // ? - Отправка\n      modal_form.forEach(form => {\n        form.addEventListener('submit', e => {\n          e.preventDefault();\n          if (modal.contains(modal_inner)) {\n            // * Если обычная модалка\n            modal_inner.classList.add(\"\".concat(rootClassName, \"__inner--hidden\"));\n            modal_success.classList.add(\"\".concat(rootClassName, \"__success--active\"));\n          } else {\n            // * Если модалка с подтверждением отправки\n            modal.classList.add(\"\".concat(rootClassName, \"--active\"));\n            (0,tua_body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__.lock)(modal);\n            window.addEventListener('click', e => {\n              modalClickOutside(e);\n            });\n          }\n        });\n      });\n    }\n  });\n}\n\n\n//# sourceURL=webpack://gulp-starter/./src/js/templates/modalFunc.js?");

/***/ }),

/***/ "./src/js/templates/tabsFunc.js":
/*!**************************************!*\
  !*** ./src/js/templates/tabsFunc.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   tabsFunc: () => (/* binding */ tabsFunc)\n/* harmony export */ });\nfunction tabsFunc(rootClassName) {\n  window.addEventListener('load', () => {\n    let tabs_buttons = document.querySelectorAll(\".\".concat(rootClassName, \"__tabs-button\"));\n    if (tabs_buttons === null) {\n      return;\n    } else {\n      let tabs_items = document.querySelectorAll(\".\".concat(rootClassName, \"__tabs-body-item\"));\n      tabs_buttons.forEach(button => {\n        button.addEventListener('click', e => {\n          tabs_buttons.forEach(button_value => {\n            button_value.classList.remove(\"\".concat(rootClassName, \"__tabs-button--active\"));\n          });\n          button.classList.add(\"\".concat(rootClassName, \"__tabs-button--active\"));\n          tabs_items.forEach(item => {\n            if (button.dataset.tab === item.dataset.tab) {\n              tabs_items.forEach(item_value => {\n                item_value.classList.remove(\"\".concat(rootClassName, \"__tabs-body-item--active\"));\n              });\n              item.classList.add(\"\".concat(rootClassName, \"__tabs-body-item--active\"));\n            }\n          });\n        });\n      });\n    }\n  });\n}\n\n\n//# sourceURL=webpack://gulp-starter/./src/js/templates/tabsFunc.js?");
...
/******/ 	__webpack_require__("./src/js/mobileMenu.js");
/******/ 	__webpack_require__("./src/js/libs/aos.js");
/******/ 	__webpack_require__("./src/js/libs/fancybox.js");
/******/ 	__webpack_require__("./src/js/libs/gsap.js");
/******/ 	__webpack_require__("./src/js/libs/swiper.js");
/******/ 	__webpack_require__("./src/js/templates/accordionFunc.js");
/******/ 	__webpack_require__("./src/js/templates/modalFunc.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/templates/tabsFunc.js");
/******/ 	
/******/ })()
;